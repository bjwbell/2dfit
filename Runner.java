...
class Runner
{
	...
	while(gui.getRenderer() == null){
 	...
 	//renderer.setLinearRing(makeTriangle(new Coordinate(0, 0), new Coordinate(400, 400), new Coordinate(400, 0)), 0);
 	//renderer.setLinearRing(makeSquare(100), 1);
	int offset = 2;
	LinearRing shape = makeS2(200);//makeSquare(200);
	renderer.setLinearRing(shape, 20);
	...
	//repainting
	//renderer.repaint(0, 0, 0, 640, 480);
    }
